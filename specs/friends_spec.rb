...
class TestFriends < MiniTest::Test
  ...
  def test_favourite_tv_show
    result = fovourite_tv_show(@person2)
  ...
  def test_add_friend
    add_friend(@person5, "Fabiola")
    actual_value = @person5[:friends].length
    expected_value = 1
  ...
  def test_remove_name
    ...
    actual_value = @person4[:friends].length
  ...
  def test_favourite_foods
    ...
    expected_value = ["charcuterie", "soup","bread","Scooby snacks","spaghetti","ratatouille","spinach"]
    assert_equal(expected_value, result)
  end
  ...
  def test_no_friend
    actual_value = no_friends(@people)
    assert_equal([@person5],actual_value)
  end
